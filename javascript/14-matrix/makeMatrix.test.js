...
test('matrix produces a 2x2 array -- regression test for the wrong-comment bug', () => {
  // The original comment claimed this produces [[undefined, undefined], ...]
  // -- verified that's wrong; it actually produces [[1, 2], [4, 3]].
  const m = matrix(2);
