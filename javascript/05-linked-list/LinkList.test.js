...
describe('Append', () => {
  test('append adds to the end of the list, same as insertLast', () => {
    const l = new List();
    l.insertLast('a');
    l.append('b');
    l.append('c');
  ...
  test('append works on an empty list', () => {
    const l = new List();
    l.append('first');
    expect(l.getFirst().data).toEqual('first');
    expect(l.size()).toEqual(1);
  });
});
describe('ForEach', () => {
